 ...
 *
 * Fields:
 * * source - actor performing the action
 * * target - target of the action
 * * action - is a verb describing the action (e.g. punched, thrown, kicked, etc.)
 * * weapon - is a tool with which the action was made (usually an item)
 * * details - is any additional text, which will be appended to the rest of the log line
 */
/proc/log_combat(atom/source, atom/target, action, atom/weapon = null, addition = null)
	...
	var/message = "has [action] [key_name(target)][postfix]"
