...
/obj/item/antag_spawner/nuke_ops/borg_tele/spawn_antag(client/C, turf/T, kind, datum/mind/user)
	...
	switch(borg_to_spawn)
		if("Medical")
			R = new /mob/living/silicon/robot/models/syndicate/medical(T)
		if("Saboteur")
			R = new /mob/living/silicon/robot/models/syndicate/saboteur(T)
		else
			R = new /mob/living/silicon/robot/models/syndicate(T) //Assault borg by default
