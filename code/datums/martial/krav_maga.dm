...
/datum/martial_art/krav_maga/proc/leg_sweep(mob/living/attacker, mob/living/defender)
	...
	log_attack(attacker, defender, "leg sweeped", "krav maga", tags = list("martial arts"))
	return TRUE
...
/datum/martial_art/krav_maga/proc/quick_choke(mob/living/attacker, mob/living/defender)//is actually lung punch
	...
	log_attack(attacker, defender, "quickchoked", "krav maga", tags = list("martial arts"))
	return TRUE
...
/datum/martial_art/krav_maga/grab_act(mob/living/attacker, mob/living/defender)
	if(check_streak(attacker, defender))
		return TRUE
	log_attack(attacker, defender, "grabbed", "krav maga", tags = list("martial arts"))
	..()

/datum/martial_art/krav_maga/harm_act(mob/living/attacker, mob/living/defender)
	if(check_streak(attacker, defender))
		return TRUE
	log_attack(attacker, defender, "punched", "krav maga", tags = list("martial arts"))
	...
	log_attack(attacker, defender, picked_hit_type, "krav maga", tags = list("martial arts"))
	return TRUE
...
/datum/martial_art/krav_maga/disarm_act(mob/living/attacker, mob/living/defender)
	...
	if(defender.body_position == STANDING_UP)
		...
		log_attack(attacker, defender, "punched", "krav maga", "nonlethally", list("martial arts"))
	if(defender.body_position == LYING_DOWN)
		defender.visible_message(span_danger("[attacker] reprimands [defender]!"), \
		...
		log_attack(attacker, defender, "stomped", "krav maga", "nonlethally", list("martial arts"))
